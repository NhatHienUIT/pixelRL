...
SAVE_PATH            = "/content/pixelRl/denoise_with_convGRUmodel/denoise_myfcn_"
...
def test(loader, agent, fout):
    ...
    for i in range(0, test_data_size, TEST_BATCH_SIZE):
        ...
        cv2.imwrite('/content/pixelRl/denoise_with_convGRUresultimage/'+str(i)+'_output.png',p)
        cv2.imwrite('/content/pixelRl/denoise_with_convGRUresultimage/'+str(i)+'_input.png',N)
...
def main(fout):
    ...
    chainer.serializers.load_npz('/content/pixelRl/denoise_with_convGRUmodel/pretrained_15.npz', agent.model)
